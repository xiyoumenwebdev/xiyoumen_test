...
var showLC = function() {
  var loadmySnapShot = JSON.parse(localStorage.getItem('drawing'));
  ...
  var save = function() {
  	 var savemySnapShot = JSON.stringify(lc.getSnapshot());
    localStorage.setItem('drawing', savemySnapShot);
    $.post("/whiteboard/", {drawing:savemySnapShot});
  }
