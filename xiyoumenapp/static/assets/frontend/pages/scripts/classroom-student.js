...
function getClassInfo() {
	...
	teastatus_list = data.teastatuslist;	
	for (ti in teastatus_list){
		if (teastatus_list[ti]=='2'){
			updateTeaEl();
			break;
		}	
	}
...
window.setInterval('getClassInfo()', 3000);
*/


function updateTeaEl() {
	$('div#media-area').empty();
  	$('div#media-area').append('<input id="btn-student-ready" type="button" class="btn btn-info" value="Ready To Begin Class">')
}

//$("input#btn-student-ready").click($.post("/chatlist/", {stustatus:1});)
